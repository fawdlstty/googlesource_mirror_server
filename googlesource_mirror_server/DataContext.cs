...
using googlesource_mirror_server.Models;
...
namespace googlesource_mirror_server {
	public class DataContext: FrameworkContext {
		...
		public DbSet<Model_AppConfig> AppConfigs { get; set; }
		...
		public override async Task<bool> DataInit (object allModules, bool IsSpa) {
			...
			if (state == true || emptydb == true) {
				...
				// 仓库缓存目录
				Set<Model_AppConfig> ().Add (new Model_AppConfig { CreateBy = "init", CreateTime = DateTime.Now, Name = "PhysicalPath", Content = "" });
				// 镜像缓存列表
